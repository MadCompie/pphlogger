<?php
 /* ----------------------------------------------------------------------------
    ...
    $Id: login.php 3067 2009-11-30 20:37:57Z piezzi $
...
if (defined('PHP_SESS')) {
# session_unregister() is DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
...
if (defined('PHP_SESS')) {
# session_register() is DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
# no need to register at all anymore
