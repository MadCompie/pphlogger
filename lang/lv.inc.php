 ...
 *
 * $Id: lv.inc.php 2726 2004-05-24 10:11:39Z cvs_iezzi $
 * credits to: Ansis Ataols Bçrziòð <ataols@latnet.lv>
 */
...
$strDellog           = "Nodzçst vçsturi";
$strTopOfPage        = "Augðup";
$strTotal            = "Kopâ";
$strHits             = "Apmeklçjumi";
$strUniqs            = "daþâdi";
$strUniq             = "daþâdi"; // daþâdi apmeklçtâji
$strPageimpressions  = "reiþu skaitu";
$strDomains          = "Muiþu vârdi";
$strConfiguration    = "Konfigurâcija";
$strCurrConfig       = "Tekoðie uzstâdîjumi:";
$strUsername         = "Lietotâja vârds";
$strPassword         = "Parole";
$strDelete           = "Nodzçst";
$strUser             = "Lietotâjs";
...
$strSet              = "uzstâdît";
$strMove             = "pârvietot";
$strDefault          = "pçc noklusçjuma";
$strCreateNew        = "radît jaunu";
$strSave             = "noglabât";
$strUnknown          = "nezinâms";
$strUndefined        = "nav definçts";
$strCache            = "íeðâ";
$strSeconds          = "sekundes";
...
// pages
$strUsrPage[0]       = "pieslçgties/atslçgties";
$strUsrPage[1]       = "vçsture";
$strUsrPage[2]       = "statistika";
$strUsrPage[3]       = "kalendâris";
$strUsrPage[4]       = "pârlûks/OS";
$strUsrPage[5]       = "uzstâdîjumi";
$strUsrPage[6]       = "lietotâja opcijas";
$strAdminPage[0]     = "administrçðana";
...
// headfoot.inc.php
$strTrackedSite      = "Tîmekïa iecirkòa pamatlapas vietrâdis:";
$strCurrentTime      = "Patlaban";
$strHeadDateFormat   = "d. M, <b>H:i</b>";
$strYourHits         = "Jûsu statistika:";
$strSlogan           = "...labâkais skaitîtâjs!";
...
$strSettings         = "Uzstâdîjumi";
$strChUserprofile    = "Lietotâja dati";
$strLoginLogout      = "Beigt darbu";

// index.php
$strEnterUsernPw     = "Lûdzu ievadiet lietotâja vârdu un paroli";
$strLostPw           = "Vai aizmirsât paroli?";
$strLinkNewPw        = "JAUNA PAROLE";
$strGetFreeAccount   = "Konts paðam";
$strSignUpUseracc    = "Reìistrçjieties!";
$strMsgWrongPw       = "<b>Nepareizs lietotâja vârds vai parole!!!</b><br />Lûdzu mçìiniet vçlreiz...";
$strMsgNewPw         = "<b>Jaunâ parole nosûtîta uz Jûsu E-pasta adresi.</b>";
// dspNewPw.php
$strForVerification  = "Lûdzu ievadiet savu lietotâja vârdu un E-pasta adresi";
$strGetIt            = "Kârtîbâ!";
$strMsgNoValidUser   = "<b>E-pasta adrese un lietotâja vârds nesapas!</b><br /> Lûdzu mçìiniet vçlreiz...";

// signup.php
$strSignUp           = "Jauna lietotâja reìistrâcija:";
$strHtmlCode         = "HTML-kods";
$strAddHtmlCode      = "Ievietojiet doto kodu savâs HTML lapâs:";
$strJsFile           = "Ja esat nozûmçjuði datni <I>pphlogger.js</I>, tad varat to nosûkt vçlreiz:";
$strInstructions     = "PAMÂCÎBA:";
$strConfLogin        = "Lai apstiprinâtu savu reìistrçðanos, lûdzu, pieslçdzçties sistçmai vçlreiz (izmantojot jauniegûto paroli):";
$strConfLogin2       = "Ja ".$cleanup_lim." stundu laikâ neapstiprinâsiet reìistrâciju, Jûsu dati tiks izdzçsti.";
$strUploadJs         = "Lûdzu, iesûtiet pievienoto Javaskripta datni (pphlogger.js) savâ serverî.";
$strNoSignUp         = "Piedodiet, bet ðobrîd nevaram piereìistrçt jaunu lietotâju!";
$strReturnToLogin    = "atgriezties sâkumlapâ";

// dspLogs.php
$strShowLogs         = "Parâdît ierakstu datnes:";
$strSelect           = "Atíeksçt";
$strUnselect         = "Atcelt";
$strAll              = "Visi";
$strTurnShowref      = "Râdît saites";
$strFullAgt          = "Pilns pârlûka vârds";
$strDemoMode         = "Sistçma darbojas izrâdîðanas reþîmâ!";
$strGuestMsg1        = "Viesiem nav dotas tiesîbas dzçst ierakstu datnes!!!";
$strGuestMsg2        = "Lûdzu, vispirms aktivizçjiet opciju «Dzçst ierakstu datnes»!";
$strViewLogs         = "Parâdît ierakstu datnes";
$strHostIP           = "Skaitïotâja vârds/IP-adrese";
$strReferrer         = "Saites";
$strReferrers        = "Saites";
$strAgent            = "Pârlûks+operçtâjsistçma";
$strRes              = "Izðíirtspçja";
$strColor            = "Krâsas";
$strTimestamp        = "Plkst.";
$strProxy            = "Proksis";
...
// dspStats.php
$strVisPerDay        = "Apmeklçtâju skaits diennaktî";
$strPerDay           = "skaits diennaktî";
$strVisPerHour       = "Apmeklçtâju skaits stundâ";
$strLast             = "pçdçjie";
$strMonth            = "mçnesis";
$strMonths           = "mçneði";
$strToday            = "ðodien";
...
$strDay              = "diena";
$strDays             = "dienas";
$strCurrOnlUsers     = "Apmeklçtâju skaits ðobrîd";
$strIPkept           = "IP-adreses tiek saglabâtas";
$strIPkept2          = "min.";
$strOnline           = "Tîklâ";
$strEntryTime        = "Ieraðanâs";
$strLastReload       = "Pçdçjâ pârlâdçðana";
$strLastUrl          = "Pçdçjais vietrâdis";
$strSince            = "Kopð";
$strMultipage        = "Daudzlapu";
$strKeywords         = "pçc atslçgvârdiem";
$strSingleWords      = "atseviðíi vârdi";
$strWholeStrings     = "pilnas rindas";
$strDownloads        = "Nosûkðanas";
$strTerritories      = "Vietas";
$str_arrMonths       = Array(1 => "Janvâris", "Februâris", "Marts", "Aprîlis", "Maijs", "Jûnijs", "Jûlijs",
                                    "Augusts", "Septembris", "Oktobris", "Novembris", "Decembris");
$str_arrMonthsAbbr   = Array(1 => "Jan", "Feb", "Mar", "Apr", "Mai", "Jûn", "Jûl", "Aug", "Sep", "Okt", "Nov", "Dec");
$str_area            = Array(
                         'EU'   => 'Eiropa',
                         'AM'   => 'Amerika',
                         'AF'   => 'Âfrika',
                         'AS'   => 'Âzija',
                         'OZ'   => 'Austrâlija un Okeânija',
                         'GUS'  => 'GUS'	# ??
                       );

// dspCalendar.php
$strShowUniqVis      = "Râdît apmeklçtâju skaitu";
$strShowPageimpress  = "Râdît nosûkðanas reiþu skaitu";
$strReload           = "Pârlâdçt";

// edSettings.php
$strCookieTxt        = "Pievienot rausi, lai paða apmeklçjumi netiktu uzskaitîti:";
$strCountMe          = "Mani var arî pieskaitît!";
$strDontCountMe      = "Rauj viòu jupis!";
$strEnableDellog     = "Dzçst ierakstu datnes (atsl./piesl.)";
$strDisableDellog    = "Atslçgt vçstures izdzçðanas iespçju";
$strEnableDellog2    = "Dzçðanas funkcija (atsl./piesl.):";
$strResetHits        = "Mainît statistiku";
$strResHitsTxt       = "nepiecieðams norâdît<br />jaunu sâkuma skaitli:";
$strMysqlDump        = "Aplûkot <I>mySQL</I> shçmu";
$strStructOnly       = "Tikai struktûru";
$strAddDropTbl       = "Pievienot tabulu";
$strStructData       = "Struktûru un datus";
$strSend             = "Nosûtît";
$strComplInserts     = "Pilnîga ievietoðana";
$strDiskSpace        = "Vietas uz diska";
$strAvailSpace       = "Brîvas vietas";
$strUsedSpace        = "Aizòemts";
$strDbSpace          = "Used database space";
$strFreeSpace        = "Brîvs";
$strFileUpload       = "Iepumpçt datnes";
$strMaxFilesize      = "Datnes maksimâlais izmçrs";
$strErrUpload        = "Kïûda! Mçìiniet vçlreiz!";
$strUploadOk         = "Datne veiksmîgi iepumpçta!";
$strFilename         = "Datnes nosaukums";
$strSize             = "Izmçrs";
$strYourLast         = "Pçdçjo";
$strCustomers        = "Apmeklçtâju saraksts";
$strYourTimeout      = "Automâtiska atslçgðanâs notiek pçc";
$strMinutes          = "bezdarbîbas minûtçm.";
$strBlocking         = "blocking";
$strShortQuery       = "short query";
$strOwnReferrers     = "own referrers";

// edUserprofile.php
$strUserprofile      = "lietotâja datu rediìçðana";
$strEditProfile      = "Ierakstiet savus datus un nospiediet pogu râmîða lejasdaïâ.";
$strUrl1Txt          = "Tîmekïa iecirkòa pamatlapas vietrâdis (bez 'http://').";
$strUrl2Txt          = "Ja pamatlapai ir vairâki vietrâþi, ievadiet pârçjos (katru jaunâ rindâ).";
$strEmail            = "E-pasts:";
$strTimezone         = "Laika josla:";
$strUserLang         = "Valoda:";
$strVisible          = "Râdît:";
$strVisibleStyle     = "Stils:";
$strTimeout          = "Automâtiska atslçgðanâs pçc (min.):";
$strEmailNotif       = "Ziòoðana pa E-pastu pçc katriem ... apmeklçjumiem";
$strDefLogNo         = "Ierakstu datòu skaits pçc noklusçjuma:";
$strKwListMode       = "Atslçgvârdu saraksta veids:";
$strAllowDemo        = "Atïaut izrâdîðanas reþîmu:";
$strTTF              = "Izvçlçties TrueType ðriftu:";
$strAvailFonts       = "Pieejamie ðrifti";
$strFontSize         = "Ðrifta izmçrs:";
$strFontColor        = "Ðrifta krâsa:";
$strBgColor          = "Fons:";
$strTransBg          = "Caurspîdîgs fons:";
$strSample           = "Paraugs:";
$strChangePw         = "Nomainît paroli:";
$strOldPw            = "Vecâ parole:";
$strNewPw            = "Jaunâ parole:";
$strReenterPw        = "Vecâ parole vçlreiz:";
$strLoadCSS          = "Ielâdçt CSS jeb stila specifikâciju:";
$strView4Msg1        = "Lietotaja dati nomainîti!";
$strView4Msg2        = "Piedodiet, kïuda!";
$strView4Msg3        = "Viesim nav tiesîbu<br />saglabât izmaiòas!!";
$strPwChanged        = "Parole nomainîta!";
$strWrongPw          = "Nepareiza parole!!";

// admin/index.php
$strAdmin            = "Administrçðana";
$strMaintenance      = "Uzturçðana";
$strCheckNewVer      = "Vai pieejama jaunâka versija?";
$strCreate           = "Jauna lietotâja reìistrâcija:";
$strAdminMsg1        = "Diemþçl ðis lietotâja vârds ir jau aizòemts!..";
$strAdminMsg2        = "Jaunais lietotâjs piereìistrçts";
$strAdminMsg3        = "Nepareiza E-pasta adrese!";
$strAdminMsg4        = "Lietotâja vârds drîkst saturçt tikai latîòu burtus, ciparus,<br /> kâ arî .,-,_, un tas nedrîkst bût garâks par 30 simboliem!";
$strAdminErr1        = "Kïûda! Mçìiniet vçlreiz!";
$strDelUser          = "Izmest lietotâju:";
$strDelErr           = "Uj! Nenostrâdâja...";
$strDelOk            = "Lietotâjs izmests!";
$strWrongPwUser      = "Nepareiza parole vai lietotâja vârds!";
$strAdminCookie      = "Administrâtora rausis";
$strNetcheck         = "Ieslçgt tîkla pârbaudi";
$strHideAccounts     = "Atslçgt lietotâju radîðanu";
$strShowAccounts     = "Radît lietotâjus";
$strReadyDelete      = "Gatavs dzçðanai";
$strMailinglist      = "Vçstkopa";
...
$strMaxLoglim        = "maksimâlais ierakstu datnes izmçrs:";
$strMaxPath          = "maksimâlais uzglabâjamais lietotâja ceïa garums:";
?>
