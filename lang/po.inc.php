<?php
/* Brazilian Portugese language localization
 *
 * $Id: po.inc.php 2726 2004-05-24 10:11:39Z cvs_iezzi $
 * credits to: Lacy Amorim
 */
...
$strDellog           = "deleção de registro";
$strTopOfPage        = "topo da página";
$strTotal            = "total";
$strHits             = "visitas";
$strUniqs            = "uniqs";
$strUniq             = "uniq";
...
$strCurrConfig       = "configuração atual:";
$strUsername         = "usuário";
$strPassword         = "senha";
$strDelete           = "deletar";
$strUser             = "usuário";
...
$loca['tz']['-12']   = "(TMG -12:00 Horas) Eniwetok, Kwajalein";
$loca['tz']['-11']   = "(TMG -11:00 Horas) Midway Island, Samoa";
$loca['tz']['-10']   = "(TMG -10:00 Horas) Hawaii";
$loca['tz']['-9']    = "(TMG -9:00 Horas) Alasca";
$loca['tz']['-8']    = "(TMG -8:00 Horas) Pacific Time (US &amp; Canada), Tijuana";
$loca['tz']['-7']    = "(TMG -7:00 Horas) Mountain Time (US &amp; Canada), Arizona";
$loca['tz']['-6']    = "(TMG -6:00 Horas) Central Time (US &amp; Canada), Mexico City";
$loca['tz']['-5']    = "(TMG -5:00 Horas) Eastern Time (US &amp; Canada), Bogota, Lima, Quito";
$loca['tz']['-4']    = "(TMG -4:00 Horas) Atlantic Time (Canada), Caracas, La Paz";
$loca['tz']['-3.5']  = "(TMG -3:30 Horas) Newfoundland";
$loca['tz']['-3']    = "(TMG -3:00 Horas) Brasíla, Buenos Aires, Georgetown, Falkland Is";
$loca['tz']['-2']    = "(TMG -2:00 Horas) Mid-Atlantic, Ascension Is., St. Helena";
$loca['tz']['-1']    = "(TMG -1:00 Horas) Açores, Cabo Verde";
$loca['tz']['0']     = "(TMG) Casablanca, Dublin, Edinburgh, London, Lisboa, Monrovia";
$loca['tz']['1']     = "(TMG +1:00 Horas) Amsterdam, Berlin, Brussels, Madrid, Paris, Roma";
$loca['tz']['2']     = "(TMG +2:00 Horas) Cairo, Helsinki, Kaliningrad, South Africa";
$loca['tz']['3']     = "(TMG +3:00 Horas) Baghdad, Riyadh, Moscow, Nairobi";
$loca['tz']['3.5']   = "(TMG +3:30 Horas) Tehran";
$loca['tz']['4']     = "(TMG +4:00 Horas) Abu Dhabi, Baku, Muscat, Tbilisi";
$loca['tz']['4.5']   = "(TMG +4:30 Horas) Kabul";
$loca['tz']['5']     = "(TMG +5:00 Horas) Ekaterinburg, Islamabad, Karachi, Tashkent";
$loca['tz']['5.5']   = "(TMG +5:30 Horas) Bombay, Calcutta, Madras, New Delhi";
$loca['tz']['6']     = "(TMG +6:00 Horas) Almaty, Colombo, Dhaka, Novosibirsk";
$loca['tz']['6.5']   = "(TMG +6:30 Horas) Rangoon";
$loca['tz']['7']     = "(TMG +7:00 Horas) Bangkok, Hanoi, Jakarta";
$loca['tz']['8']     = "(TMG +8:00 Horas) Beijing, Hong Kong, Perth, Singapore, Taipei";
$loca['tz']['9']     = "(TMG +9:00 Horas) Osaka, Sapporo, Seoul, Tokyo, Yakutsk";
$loca['tz']['9.5']   = "(TMG +9:30 Horas) Adelaide, Darwin";
$loca['tz']['10']    = "(TMG +10:00 Horas) Canberra, Guam, Melbourne, Sydney, Vladivostok";
$loca['tz']['11']    = "(TMG +11:00 Horas) Magadan, New Caledonia, Solomon Islands";
$loca['tz']['12']    = "(TMG +12:00 Horas) Auckland, Wellington, Fiji, Marshall Island";
...
// pages
$strUsrPage[0]       = "entrar/sair";
$strUsrPage[1]       = "registros";
$strUsrPage[2]       = "estatísticas";
$strUsrPage[3]       = "estatísticas 2";
$strUsrPage[4]       = "estatísticas 3";
$strUsrPage[5]       = "configuração";
$strUsrPage[6]       = "perfil do usuário";
$strAdminPage[0]     = "administração";
$strAdminPage[1]     = "criar/deletar contas";
$strAdminPage[2]     = "monstrar contas";
$strAdminPage[3]     = "monstrar últimos visitantes";
$strAdminPage[4]     = "CSS editor";
$strAdminPage[5]     = "estatísticas";
...
// headfoot.inc.php
$strTrackedSite      = "site analisado:";
$strCurrentTime      = "hora atual";
$strHeadDateFormat   = "d. M, <b>H:i</b>";
$strYourHits         = "suas visitas:";
$strSlogan           = "...seu contador de visitas!";
...
// signup.php
$strSignUp           = "Adquira uma nova conta PowerPhlogger:";
$strHtmlCode         = "Código HTML";
$strAddHtmlCode      = "adicione o seguinte código HTML em todas as páginas que deseja contar:";
$strJsFile           = "Caso tenha perdido o arquivo pphlogger.js, faça o download aqui:";
$strInstructions     = "INSTRUÇÕES:";
$strConfLogin        = "para confirmar sua nova conta, você precisará entrar com sua senha, enviada a você por e-mail.";
$strConfLogin2       = "Caso não confirme sua conta, esta será deletada após ".$cleanup_lim." horas";
$strUploadJs         = "envie o arquivo pphlogger.js que você recebeu para seu servidor.";
$strNoSignUp         = "Desculpe-nos, atualmente não estamos oferecendo este serviço gratuito neste servidor  !";
...
$strAll              = "todos";
$strTurnShowref      = "ver referências";
$strFullAgt          = "full agent";
$strDemoMode         = "executando em modo de demonstração!";
$strGuestMsg1        = "como visitante você não pode deletar nenhum registro!!!";
$strGuestMsg2        = "favor habilitar a função deletar registro!";
$strViewLogs         = "visualizar registros";
$strHostIP           = "Servidor/IP";
$strReferrer         = "Referência";
$strReferrers        = "Referências";
$strAgent            = "Informações do Navegador";
$strRes              = "res";
$strColor            = "cor";
$strTimestamp        = "tempo";
$strProxy            = "proxy";
...
// dspStats.php
$strVisPerDay        = "Visitantes por dia";
$strPerDay           = "por dia";
...
$strToday            = "today";
$strAverage          = "média";
$strAverageAbbr      = "média.";
$strDay              = "dia";
$strDays             = "dias";
$strCurrOnlUsers     = "usuários online";
$strIPkept           = "Os números de IP's são guardados por";
$strIPkept2          = "minutos";
$strOnline           = "online";
$strEntryTime        = "hora de entrada";
$strLastReload       = "último reload";
$strLastUrl          = "último URL";
$strSince            = "desde";
$strMultipage        = "multi-páginas";
$strKeywords         = "palavras-chaves";
$strSingleWords      = "single words";
$strWholeStrings     = "whole strings";
$strDownloads        = "downloads";
$strTerritories      = "áreas";
$str_arrMonths       = Array(1 => "Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", 
                                    "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro");
$str_arrMonthsAbbr   = Array(1 => "Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez");
$str_area            = Array(
                         'EU'   => 'Europe',
                         'AM'   => 'America',
                         'AF'   => 'Africa',
...
// edSettings.php
$strCookieTxt        = "Acione o cookie para evitar contar a você mesmo:";
$strCountMe          = "Conte-me!";
$strDontCountMe      = "Não me conte!";
$strEnableDellog     = "habilitar deleção de registro";
$strDisableDellog    = "desabilitar deleção de registro";
$strEnableDellog2    = "habilitar função deletar:";
$strResetHits        = "zerar as visitas";
$strResHitsTxt       = "para reiniciar sua contagem de visitas, entre um valor:";
$strMysqlDump        = "Veja o mySQL (schema)";
$strStructOnly       = "Apenas estrutura";
$strAddDropTbl       = "Adicione 'drop table'";
$strStructData       = "Estrutura e dados";
$strSend             = "Enviar";
$strComplInserts     = "inserção completa";
$strDiskSpace        = "Espaço no disco";
$strAvailSpace       = "Espaço disponível no disco";
$strUsedSpace        = "Espaço usado no disco";
$strDbSpace          = "Used database space";
$strFreeSpace        = "Espaço restante no disco";
$strFileUpload       = "múltiplo envio de arquivos";
$strMaxFilesize      = "tamanho máximo de arquivos";
$strErrUpload        = "Erro ao enviar arquivo. Tente novamente.";
$strUploadOk         = "Arquivo enviado com sucesso!!";
$strFilename         = "nome do arquivo";
$strSize             = "tamanho";
$strYourLast         = "seus últimos";
$strCustomers        = "clientes";
$strYourTimeout      = "seu intervalo máximo de tempo é de";
$strMinutes          = "minutos.";
...
// edUserprofile.php
$strUserprofile      = "alterar perfil de usuário";
$strEditProfile      = "edite sua configuração e aperte o botão:";
$strUrl1Txt          = "URL para sua página inicial.";
$strUrl2Txt          = "Se você tem URLs alternativos, entre um em cada linha:";
$strEmail            = "email:";
$strTimezone         = "fuso horário:";
$strUserLang         = "idioma:";
$strVisible          = "visível:";
$strVisibleStyle     = "estilo de visibilidade:";
$strTimeout          = "tempo máximo:";
$strEmailNotif       = "notificação por e-mail: a cada...";
$strDefLogNo         = "número padrão de registros para mostrar:";
$strKwListMode       = "modo de lista de palavras-chaves:";
$strAllowDemo        = "permitir modo de demonstração:";
$strTTF              = "escolha uma letra TrueType:";
$strAvailFonts       = "available fonts";
$strFontSize         = "tamanho da letra:";
$strFontColor        = "cor da letra:";
$strBgColor          = "cor de fundo:";
$strTransBg          = "fundo transparente:";
$strSample           = "image de exemplo:";
$strChangePw         = "alterar sua senha:";
$strOldPw            = "senha antiga:";
$strNewPw            = "nova senha:";
$strReenterPw        = "entre novamente sua senha:";
$strLoadCSS          = "utilizar stylesheet:";
$strView4Msg1        = "perfil de usuário atualizado com sucesso!";
$strView4Msg2        = "Não foi possível atualizar seu perfil de usuário!!!";
$strView4Msg3        = "como visitante você não pode<br />fazer qualquer alteração!";
$strPwChanged        = "senha alterada !";
$strWrongPw          = "senha errada !!";

// admin/index.php
$strAdmin            = "administration";
$strMaintenance      = "maintenance";
$strCheckNewVer      = "Check For New Version";
$strCreate           = "Criar uma nova conta de usuário:";
$strAdminMsg1        = "este nome de usuário já existe";
$strAdminMsg2        = "sua conta foi criada com sucesso";
$strAdminMsg3        = "Você digitou um e-mail inválido!";
$strAdminMsg4        = "usernames must only contain alphanumeric characters,<br />.,-,_, and must be less than 30 characters!";
$strAdminErr1        = "houve um erro ao criar a conta";
$strDelUser          = "Deletar um usuário:";
$strDelErr           = "houve um problema !!";
$strDelOk            = "todos os dados do usuário foram deletados!";
$strWrongPwUser      = "senha ou nome de usuário errado !";
$strAdminCookie      = "criar cookie de administrador";
$strNetcheck         = "habilitar netcheck";
$strHideAccounts     = "esconder contas de usuários";
...
$strMaxLoglim        = "limite máximo de logs:";
