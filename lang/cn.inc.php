 ...
 *
 * $Id: cn.inc.php 2726 2004-05-24 10:11:39Z cvs_iezzi $
...
$loca['tz']['-12']   = "(GMT -12:00 hours) 埃尼威托克岛, 夸贾林岛";
$loca['tz']['-11']   = "(GMT -11:00 hours) 中途岛, 萨摩亚群岛";
$loca['tz']['-10']   = "(GMT -10:00 hours) 夏威夷州";
$loca['tz']['-9']    = "(GMT -9:00 hours) 阿拉斯加州";
$loca['tz']['-8']    = "(GMT -8:00 hours) 太平洋时间 (美国 &amp; 加拿大), 提华纳";
$loca['tz']['-7']    = "(GMT -7:00 hours) 山地标准时间 (美国 &amp; 加拿大), 亚利桑那州";
$loca['tz']['-6']    = "(GMT -6:00 hours) 中区时 (美国 &amp; 加拿大), 墨西哥城";
$loca['tz']['-5']    = "(GMT -5:00 hours) 东部时间 (美国 &amp; 加拿大), 波哥大, 利马, 基多";
$loca['tz']['-4']    = "(GMT -4:00 hours) 大西洋时间 (加拿大), 加拉加斯, 拉巴斯";
$loca['tz']['-3.5']  = "(GMT -3:30 hours) 纽芬兰";
$loca['tz']['-3']    = "(GMT -3:00 hours) 巴西, 布宜诺斯艾利斯, 乔治顿, 福克兰群岛";
$loca['tz']['-2']    = "(GMT -2:00 hours) 中大西洋, 亚森松岛, 圣赫勒您";
$loca['tz']['-1']    = "(GMT -1:00 hours) 亚速尔群岛, 维德角岛";
$loca['tz']['0']     = "(GMT) 卡萨布兰卡, 都柏林, 爱丁堡, 伦敦, 里斯本, 蒙罗维亚";
$loca['tz']['1']     = "(GMT +1:00 hours) 阿姆斯特丹, 柏林, 布鲁塞尔, 哥本哈根, 马德里, 巴黎, 罗马";
$loca['tz']['2']     = "(GMT +2:00 hours) 开罗, 赫尔辛基, 加里宁格勒, 南非";
$loca['tz']['3']     = "(GMT +3:00 hours) 巴格达, 利雅德, 莫斯科, 内罗毕";
$loca['tz']['3.5']   = "(GMT +3:30 hours) 德黑兰";
$loca['tz']['4']     = "(GMT +4:00 hours) 阿布扎比, 巴库, 马斯喀特, 第比利斯";
$loca['tz']['4.5']   = "(GMT +4:30 hours) 喀布尔";
$loca['tz']['5']     = "(GMT +5:00 hours) 伊卡特琳堡, 伊斯兰堡, 卡拉奇, 塔什干";
$loca['tz']['5.5']   = "(GMT +5:30 hours) 孟买, 加尔各答, 马德拉斯, 新德里";
$loca['tz']['6']     = "(GMT +6:00 hours) 阿蒙提, 科伦坡, 达卡，新西伯利亚";
$loca['tz']['6.5']   = "(GMT +6:30 hours) 仰光";
$loca['tz']['7']     = "(GMT +7:00 hours) 曼谷, 河内, 雅加达";
$loca['tz']['8']     = "(GMT +8:00 hours) 北京, 香港, 佩思, 新加坡, 台北";
$loca['tz']['9']     = "(GMT +9:00 hours) 大阪, 札幌, 汉城, 东京, 雅库茨克";
$loca['tz']['9.5']   = "(GMT +9:30 hours) 阿得雷德, 达尔文";
$loca['tz']['10']    = "(GMT +10:00 hours) 堪培拉，关岛，莫尔本, 悉尼, 符拉迪沃斯托克";
$loca['tz']['11']    = "(GMT +11:00 hours) 马加丹, 新卡里多尼亚, 所罗门群岛";
$loca['tz']['12']    = "(GMT +12:00 hours) 奥克兰, 威灵顿, 斐济, 马歇尔群岛";
...
// headfoot.inc.php
$strTrackedSite      = "已记录网站:";
$strCurrentTime      = "当前时间";
$strHeadDateFormat   = "M d, <b>h:iA</b>";
$strYourHits         = "您的网站流量:";
$strSlogan           = "...最棒的网站流量统计工具！";
...
// signup.php
$strSignUp           = "申请一个新 PowerPhlogger 帐号：";
$strHtmlCode         = "HTML 代码";
$strAddHtmlCode      = "别忘了在你想记录的页面加上以下代码：";
$strJsFile           = "假如您丢失你的 pphlogger.js 文件，可以点按此下载：";
$strInstructions     = "说明指引：";
$strConfLogin        = "为了确认您申请的新帐号，您必须使用我们寄送到您电邮信箱的密码登入。";
$strConfLogin2       = "假如您未确认帐号启用，您的帐号将在 ".$cleanup_lim." 个小时後自动删除";
$strUploadJs         = "请以附件带档方式上传你收到的 pphlogger.js 文件。";
$strNoSignUp         = "对不起，当前本伺服器暂时不提供免费流量统计服务帐号申请！";
...
$strAll              = "所有";
$strTurnShowref      = "开启显示设置开关";
$strFullAgt          = "full agent";
$strDemoMode         = "运行演示模式！";
$strGuestMsg1        = "您当前是访客身分，不能删除任何记录！";
$strGuestMsg2        = "请记得启用删除记录功能！";
$strViewLogs         = "检视记录";
$strHostIP           = "主机 / IP";
$strReferrer         = "来源网址";
$strReferrers        = "导流来源";
...
$strDay              = "天";
$strDays             = "天";
$strCurrOnlUsers     = "当前线上用户";
$strIPkept           = "单一 IP 数据只保留前";
$strIPkept2          = "分钟为准";
$strOnline           = "上线";
$strEntryTime        = "进入时间";
...
$strDownloads        = "下载量";
$strTerritories      = "所在国家";
$str_arrMonths       = Array(1 => "一月", "二月", "叁月", "四月", "五月", "六月", "七月", 
                                    "八月", "九月", "十月", "十一月", "十二月");
$str_arrMonthsAbbr   = Array(1 => "一月", "二月", "叁月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月");
$str_area            = Array(
                         'EU'   => 'Europe',
                         'AM'   => 'America',
                         'AF'   => 'Africa',
...
// edSettings.php
$strCookieTxt        = "设置 cookie 防止记录你自己浏览：";
$strCountMe          = "记录";
$strDontCountMe      = "不要记录";
$strEnableDellog     = "启用删除记录";
$strDisableDellog    = "停用删除记录";
$strEnableDellog2    = "启用删除记录：";
$strResetHits        = "重设计数值";
$strResHitsTxt       = "请输入你要重设後的数值：";
$strMysqlDump        = "检视 mySQL 汇出数据 (数据结构)";
$strStructOnly       = "仅数据结构";
$strAddDropTbl       = "新增 '丢弃数据库表格'";
$strStructData       = "数据结构与数据";
$strSend             = "送出";
$strComplInserts     = "插入数据完成";
$strDiskSpace        = "磁盘空间";
$strAvailSpace       = "可用磁盘空间";
$strUsedSpace        = "已用磁盘空间";
$strDbSpace          = "Used database space";
$strFreeSpace        = "剩馀磁盘空间";
$strFileUpload       = "上传多文件";
$strMaxFilesize      = "最大文件大小限制";
$strErrUpload        = "上传错误，请再试一次！";
$strUploadOk         = "文件已成功上传！";
$strFilename         = "文件名称";
$strSize             = "文件大小";
$strYourLast         = "前";
$strCustomers        = "位访客";
$strYourTimeout      = "您的逾时值当前设置为";
$strMinutes          = "分钟";
...
// edUserprofile.php
$strUserprofile      = "更改用户帐号数据";
$strEditProfile      = "点按按钮编辑你的设置：";
$strUrl1Txt          = "指到你的网站首页 index 的网址";
$strUrl2Txt          = "如果还有其他网址，在以下栏位每行可以输入一笔：";
$strEmail            = "电子邮件：";
$strTimezone         = "时区：";
$strUserLang         = "语言：";
$strVisible          = "显示：";
$strVisibleStyle     = "显示风格：";
$strTimeout          = "逾时值：";
$strEmailNotif       = "电邮通知：每...";
$strDefLogNo         = "内定显示记录笔数：";
$strKwListMode       = "关键字清单模式：";
$strAllowDemo        = "允许演示模式：";
$strTTF              = "选择 TrueType 字形：";
...
$strReenterPw        = "确认新密码：";
$strLoadCSS          = "载入样式表：";
$strView4Msg1        = "用户帐号数据已经更新成功！";
$strView4Msg2        = "系统无法更新你的帐号数据！";
$strView4Msg3        = "您当前是访客身分，<br />不能更动任何记录！";
$strPwChanged        = "通关密码已更改！";
$strWrongPw          = "通关密码错误！";
...
$strCreate           = "新增用户帐号：";
$strAdminMsg1        = "这个登入名称已经有人使用了";
$strAdminMsg2        = "用户帐号已成功建立";
$strAdminMsg3        = "你输入的电子邮件信箱格式错误！";
$strAdminMsg4        = "usernames must only contain alphanumeric characters,<br />.,-,_, and must be less than 30 characters!";
$strAdminErr1        = "新增用户帐号时发生错误";
$strDelUser          = "删除用户：";
$strDelErr           = "系统发生错误！";
$strDelOk            = "所有用户数据已删除！";
$strWrongPwUser      = "通关密码或登入名称错误！";
$strAdminCookie      = "新增管理员 cookie";
$strNetcheck         = "启用网路检查功能";
$strHideAccounts     = "隐藏用户帐号";
$strShowAccounts     = "显示用户帐号";
