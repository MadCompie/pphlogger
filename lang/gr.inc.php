 ...
 *
 * $Id: gr.inc.php 2726 2004-05-24 10:11:39Z cvs_iezzi $
...
$strOn               = "on";
$strOff              = "off";
$strEnable           = "ενεργοποίησε";
$strEnabled          = "ενεργοποιημένο";
$strDisable          = "απενεργοποίησε";
$strDisabled         = "απενεργοποιημένο";
$strDellog           = "της διαγραφής καταγραφών";
$strTopOfPage        = "αρχή σελίδας";
$strTotal            = "Σύνολο";
$strHits             = "Αριθμός επισκεπτών";
$strUniqs            = "uniqs";
$strUniq             = "uniq";
$strPageimpressions  = "pageimpressions";
$strDomains          = "domains";
$strConfiguration    = "διαμόρφωση";
$strCurrConfig       = "τρέχουσα διαμόρφωση:";
$strUsername         = "όνομα";
$strPassword         = "κωδικός";
$strDelete           = "διαγραφή";
$strUser             = "χρήστης";
...
$strMove             = "μετακίνηση";
$strDefault          = "αρχικό";
$strCreateNew        = "δημιουργία καινούριου";
$strSave             = "αποθήκευση";
$strUnknown          = "unknown";
...
$strUsrPage[1]       = "καταγραφές";
$strUsrPage[2]       = "στατιστικά";
$strUsrPage[3]       = "ημερολόγιο";
$strUsrPage[4]       = "browser/λειτουργικό";
$strUsrPage[5]       = "ρυθμίσεις";
$strUsrPage[6]       = "προφίλ χρήστη";
$strAdminPage[0]     = "διαχειριστής";
$strAdminPage[1]     = "δημ/διαγ λογ/μού";
$strAdminPage[2]     = "εμφάνιση λογ/μού";
$strAdminPage[3]     = "εμφάνιση τελευτ πελ";
$strAdminPage[4]     = "επεξεργασία css";
$strAdminPage[5]     = "Δυναμικά στατ/κά";
$strAdminPage[6]     = "Λίστα email";
...
// headfoot.inc.php
$strTrackedSite      = "το site καταγράφηκε:";
$strCurrentTime      = "τρέχουσα ώρα";
$strHeadDateFormat   = "M d, <b>h:iA</b>";
$strYourHits         = "επισκέψεις:";
$strSlogan           = "...your ultimative logging-tool!";
$strLogs             = "καταγραφές";
$strStats1           = "στατιστικά";
$strStats2           = "στατ/κά 2";
$strStats3           = "στατ/κά 3";
$strStats4           = "στατ/κά 4";
$strStats5           = "στατ/κά 5";
$strSettings         = "ρυθμίσεις";
$strChUserprofile    = "προφίλ χρήστη";
...
// signup.php
$strSignUp           = "Γραφτείτε για ένα νέο λογ/μό στο PowerPhlogger:";
$strHtmlCode         = "HTML Κώδικας";
$strAddHtmlCode      = "προσθέστε τον ακόλουθο HTML Κώδικα σε όλες τις σελίδες που θέλετε να καταγραφεί:";
$strJsFile           = "Αν έχετε χάσει το αρχείο pphlogger.js, κατεβάστε το από εδώ:";
$strInstructions     = "ΟΔΗΓΙΕΣ:";
$strConfLogin        = "για να επιβεβαιωθεί το καινούριο σας account, πρέπει να κάνετε login με τον κωδικό (password) που στάλθηκε στο email σας.";
$strConfLogin2       = "Αν δεν επιβεβαιώσετε το account σας θα διαγραφεί μετά από ".$cleanup_lim." ώρες";
$strUploadJs         = "ανεβάστε το αρχείο pphlogger.js που λάβατε ως συνημμένο.";
$strNoSignUp         = "Συγγνώμη, προσωρινά δεν δεχόμαστε δωρεάν accounts σε αυτόν τον server !";
$strReturnToLogin    = "return to login";

// dspLogs.php
$strShowLogs         = "εμφάνιση καταγραφών:";
$strSelect           = "select";
...
$strGuestMsg1        = "σαν guest-χρήστης δεν επιτρέτε να σβήσετε τα logs!!!";
$strGuestMsg2        = "παρακαλώ ενεργοποιήστε την επιλογή διαγραφή-καταγραφής!";
$strViewLogs         = "εμφάνιση καταγραφών";
$strHostIP           = "Host / IP";
$strReferrer         = "Συστήθηκε από";
$strReferrers        = "Συστήθηκε από";
$strAgent            = "Agent Πληροφορίες";
$strRes              = "ανάλυση";
$strColor            = "χρώμα";
$strTimestamp        = "Χρονοσφραγίδα";
$strProxy            = "proxy";

// dspStats.php
$strVisPerDay        = "Επισκέπτες ανά ημέρα";
$strPerDay           = "ανά ημέρα";
$strVisPerHour       = "Visitors per hour";
$strLast             = "προηγούμενος";
$strMonth            = "μήνας";
$strMonths           = "μήνες";
$strToday            = "today";
$strAverage          = "μέσος όρος";
$strAverageAbbr      = "μεσ.όρ.";
$strDay              = "ημέρα";
$strDays             = "ημέρες";
$strCurrOnlUsers     = "online χρήστες";
$strIPkept           = "οι IP κρατούνται για τα προηγούμενα";
$strIPkept2          = "λεπτά";
$strOnline           = "online";
$strEntryTime        = "ώρα εισόδου";
$strLastReload       = "τελευταία επαναφορά";
$strLastUrl          = "τελευταία URL";
$strSince            = "από";
$strMultipage        = "πολλές σελίδες";
$strKeywords         = "λέξεις κλειδιά";
$strSingleWords      = "single words";
$strWholeStrings     = "whole strings";
$strDownloads        = "downloads";
$strTerritories      = "περιοχές";
$str_arrMonths       = Array(1 => "Ιανουάριος", "Φεβρουάριος", "Μάρτιος", "Απρίλιος", "Μάιος", "Ιούνιος", "Ιούλιος", 
                                    "Αύγουστος", "Σεπτέμβριος", "Οκτώβριος", "Νοέμβριος", "Δεκέμβριος");
$str_arrMonthsAbbr   = Array(1 => "Ιαν", "Φεβ", "Μαρ", "Απρ", "Μάι", "Ιουν", "Ιουλ", "Αυγ", "Σεπ", "Οκτ", "Νοε", "Δεκ");
$str_area            = Array(
                         'EU'   => 'Europe',
                         'AM'   => 'America',
                         'AF'   => 'Africa',
...
// edSettings.php
$strCookieTxt        = "Ρύθμιση του cookie για να μην καταγράφει την ΙΡ σου:";
$strCountMe          = "Μέτρησέ με!";
$strDontCountMe      = "Μη με μετράς!";
$strEnableDellog     = "ενεργοποίηση της διαγραφής καταγραφών";
$strDisableDellog    = "απενεργοποίησε της διαγραφής καταγραφών";
$strEnableDellog2    = "ενεργοποίησε την χρήση της διαγραφής:";
$strResetHits        = "επαναφορά μετρητή";
$strResHitsTxt       = "για να επαναφέρετε τον μετρητή σας παρακαλώ εισάγετε τον νέο αριθμό:";
$strMysqlDump        = "View mySQL dump (schema)";
$strStructOnly       = "Μόνο δομή";
$strAddDropTbl       = "Add 'drop table'";
$strStructData       = "Δομή και δεδομένα";
$strSend             = "Αποστολή";
$strComplInserts     = "ολοκλήρωση εισαγωγών";
$strDiskSpace        = "Χώρος δίσκου";
$strAvailSpace       = "Διαθέσιμος χώρος δίσκου";
$strUsedSpace        = "Κατειλημμένος χώρος δίσκου";
$strDbSpace          = "Used database space";
$strFreeSpace        = "Ελεύθερος χώρος";
$strFileUpload       = "ανέβασμα πολλαπλών αρχείων";
$strMaxFilesize      = "μέγιστο μέγεθος αρχείου";
$strErrUpload        = "Λάθος κατά το ανέβασμα. Προσπαθήστε ξανά.";
$strUploadOk         = "Επιτυχημένο ανέβασμα!!";
$strFilename         = "όνομα αρχείου";
$strSize             = "μέγεθος";
$strYourLast         = "οι τελευταίοι";
$strCustomers        = "πελάτες";
$strYourTimeout      = "ο χρόνος σας λήγει σε";
$strMinutes          = "λεπτά";
...
// edUserprofile.php
$strUserprofile      = "αλλαγή προφίλ χρήστη";
$strEditProfile      = "κάντε τις αλλαγές σας και πατήστε το κουμπί:";
$strUrl1Txt          = "URL στο κεντρικό αρχείο index.";
$strUrl2Txt          = "Αν έχετε εναλλακτικές URLs προσθέστε την καθεμία σε καινούρια σειρά:";
$strEmail            = "email:";
$strTimezone         = "η ζώνη ώρας σας:";
$strUserLang         = "η γλώσσα σας:";
$strVisible          = "εμφανές:";
$strVisibleStyle     = "εμφανές στυλ:";
$strTimeout          = "τέλος χρόνου:";
$strEmailNotif       = "ειδοποίηση με email: κάθε...";
$strDefLogNo         = "αρχικός αριθμός καταγραφών:";
$strKwListMode       = "λίστα λέξεων-κλειδιών mode:";
$strAllowDemo        = "επιτρέπω demo-mode:";
$strTTF              = "διαλέξτε TrueType-γραμματοσειρά:";
$strAvailFonts       = "available fonts";
$strFontSize         = "μέγεθος γραμματοσειράς:";
$strFontColor        = "χρώμα γραμματοσειράς:";
$strBgColor          = "χρώμα φόντου:";
$strTransBg          = "διάφανο φόντο:";
$strSample           = "δείγμα εικόνας:";
$strChangePw         = "αλλαγή προσωπικού κωδικού:";
$strOldPw            = "παλιός κωδικός:";
$strNewPw            = "νέος κωδικός:";
$strReenterPw        = "νέος κωδικός ξανά:";
$strLoadCSS          = "φόρτωμα στυλ σελίδων:";
$strView4Msg1        = "το προφίλ χρήστη ενημερώθηκε επιτυχώς!";
$strView4Msg2        = "Δεν μπόρεσε να ενημερωθεί το προφίλ χρήστη!!!";
$strView4Msg3        = "σαν επισκέπτης δεν μπορείς<br />να κάνεις αλλαγές!";
$strPwChanged        = "ο κωδικός άλλαξε !";
$strWrongPw          = "λάθος κωδικός !!";

// admin/index.php
$strAdmin            = "διαχειριστής";
$strMaintenance      = "διατήρηση";
$strCheckNewVer      = "Έλεγξε για νέα έκδοση";
$strCreate           = "Δημιούργησε νέο λογαριασμό:";
$strAdminMsg1        = "το όνομα χρήστη υπάρχει ήδη";
$strAdminMsg2        = "ο χρήστης δημιουργήθηκε επιτυχώς";
$strAdminMsg3        = "Το email που γράψατε είναι λάθος!";
$strAdminMsg4        = "usernames must only contain alphanumeric characters,<br />.,-,_, and must be less than 30 characters!";
$strAdminErr1        = "παρουσιάστηκε λάθος κατά τη δημιουργία χρήστη";
$strDelUser          = "Διαγράψτε ένα χρήστη:";
$strDelErr           = "παρουσιάστηκε πρόβλημα !!";
$strDelOk            = "διαγράφηκαν όλα τα δεδομένα του χρήστη!";
$strWrongPwUser      = "λάθος κωδικός ή όνομα !";
$strAdminCookie      = "δημιουργία cookie διαχειριστή";
$strNetcheck         = "ενεργοποίηση netcheck";
$strHideAccounts     = "απόκρυψη λογαριασμών χρηστών";
$strShowAccounts     = "εμφάνιση λογαριασμών χρηστών";
$strReadyDelete      = "έτοιμο για διαγραφή";
$strMailinglist      = "λίστα email";
...
$strMaxLoglim        = "μέγιστο όριο καταγραφών:";
$strMaxPath          = "μέγιστος αριθμός αποθηκευμένων διαδρομών χρηστών:";
?>
