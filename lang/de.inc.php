 ...
 *
 * $Id: de.inc.php 2726 2004-05-24 10:11:39Z cvs_iezzi $
 * credits to: Carsten Albrecht <albrecht@caits.de> from CAITS.DE
 *             Jürgen Wöbcke <J.Woebcke@gmx.net>
...
$strUniqs            = "Hits";
$strUniq             = "Hits";
$strPageimpressions  = "Seitenaufrufe";
$strDomains          = "Domains";
...
$loca['setup']['header6']                         = "Anzeigelimit";
$loca['setup']['header7']                         = "Anzeige-Einstellungen";
$loca['setup']['intro_txt']                       = "Dieses Script wird Ihnen helfen, die n&ouml;tigen Einstellungen vorzunehmen. Sie werden nun durch einige Konfigurationsmen&uuml;s gef&uuml;hrt. Jede Seite deckt einen anderen Bereich der Konfiguration ab.";
...
$loca['setup']['step2_txt']                       = "<b>Optionale Einstellungen</b> -- F&uuml;r die meisten Einstellungen auf dieser Seite sollte der Standardwert ausreichen. &Auml;ndern Sie die Werte nur, wenn Sie auch wirklich wissen, was f&uuml;r Auswirkungen dies hat.";
$loca['setup']['step3_txt_a']                     = "<b>Konfiguration erfolgreich!</b> -- Sie k&ouml;nnen nun beginnen, PowerPhlogger anzuwenden.<br /><br />Vergessen Sie bitte nicht, Ihr /admin Verzeichnis mit .htaccess vor unbefugtem Zugang zu sch&uuml;tzen. Dasselbe gilt auch f&uuml;r das Verzeichnis /upgrade. Bitte nehmen Sie sich auch die Zeit, die Dokumentation durchzulesen.";
$loca['setup']['step3_txt_b']                     = "Sie k&ouml;nnen nun mit dem Er&ouml;ffnen von neuen Benutzerkonten beginnen.";

$loca['setup']['pphlogger_location']['title']     = "PowerPhlogger Verzeichnis";
...
$loca['setup']['loopback_bug']['descr']           = "Achtung: Bitte nur einschalten, falls Sie Probleme mit falschen IP/Proxy-Informationen haben! Dieses Problem tritt bekanntlich nur bei F2S-Kunden auf.";
...
$loca['setup']['md5form']['descr']                = "Hier k&ouml;nnen Sie die Verschl&uuml;sselung (per JavaScript) f&uuml;r das Login-Formular ein- oder ausschalten. Sollte es Probleme mit dem Einloggen geben, so schalten Sie diese Funktion bitte aus.";
...
$loca['setup']['mpfront_lim']['descr']            = "Limit für die Seiten unterhalb der Loganzeige.";
...
$strAdminPage[2]     = "Benutzerkonten anzeigen";
...
$strCurrentTime      = "Aktuelles Datum / Uhrzeit";
$strHeadDateFormat   = "d.m.Y - <b>H:i</b>";
$strYourHits         = "Ihre Hits:";
$strSlogan           = "...Ihr ultimatives Logging-Tool!";

// index.php
$strEnterUsernPw     = "Bitte geben Sie Ihren Benutzernamen sowie das Passwort ein";
...
$strMsgWrongPw       = "<b>Ihr Passwort oder der Benutzername ist nicht g&uuml;ltig!</b><br />Versuchen Sie es bitte noch einmal...";
$strMsgNewPw         = "<b>Ihr neues Passwort wurde erfolgreich erstellt!</b><br />Es wurde an Ihre E-Mailadresse versandt.";

// dspNewPw.php
$strForVerification  = "Zur &Uuml;berpr&uuml;fung geben Sie bitte Ihren Benutzernamen sowie die E-Mailadresse ein";
$strGetIt            = "Anfordern!";
$strMsgNoValidUser   = "<b>Ihr Benutzername oder die E-Mailadresse ist nicht g&uuml;ltig.</b><br />Versuchen Sie es bitte noch einmal...";
...
$str_arrMonthsAbbr   = Array(1 => "Jan", "Feb", "Mrz", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez");
$str_area            = Array(
                         'EU'   => 'Europa',
                         'AM'   => 'Amerika',
                         'AF'   => 'Afrika',
...
// dspCalendar.php
$strShowUniqVis      = "Anzahl der Besucher anzeigen";
...
$strAdminMsg1        = "Dieser Benutzername existiert schon!";
$strAdminMsg2        = "Der Benutzer wurde erfolgreich angelegt!";
...
$strReloadKeyw2      = "Bitte f&uuml;hren Sie diese Funktion nicht aus, es sei denn, Sie haben die Datei 'engines-list.ini' editiert!";
