<?php
// $Id: edCss.inc.php 3068 2009-11-30 20:40:49Z piezzi $
...
switch (@$action) {
	...
	case $strSave:
        // prevent user of defining global CSS templates with userid = 0 or different userid
        if ($fields['userid'] != $id) {
            die(sprintf('Break-in attempt! Userid %s not allowed.', $fields['userid']));
        }
